...
const ICONS_LIST = {
  ...
  ear_nose_throat: require('./icons/specialties/ear_nose_throat.png'),
  ...
  hepatology: require('./icons/specialties/hepatology.png'),
  ...
  outpatient: require('./icons/specialties/outpatient.png'),
  ...
  bacteria: require('./icons/specialties/bacteria.png'),
  physiology: require('./icons/specialties/physiology.png'),
  histology: require('./icons/specialties/histology.png'),
};
